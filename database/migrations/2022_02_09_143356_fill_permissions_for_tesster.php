...
class FillPermissionsForTesster extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTesster constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tesster',
            'admin.tesster.index',
            'admin.tesster.create',
            'admin.tesster.show',
            'admin.tesster.edit',
            'admin.tesster.delete',
            'admin.tesster.bulk-delete',
        ]);
