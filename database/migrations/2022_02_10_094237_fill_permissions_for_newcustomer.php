...
class FillPermissionsForNewcustomer extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForNewcustomer constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.newcustomer',
            'admin.newcustomer.index',
            'admin.newcustomer.create',
            'admin.newcustomer.show',
            'admin.newcustomer.edit',
            'admin.newcustomer.delete',
            'admin.newcustomer.bulk-delete',
        ]);
