...
class FillPermissionsForHotelroom extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForHotelroom constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.hotelroom',
            'admin.hotelroom.index',
            'admin.hotelroom.create',
            'admin.hotelroom.show',
            'admin.hotelroom.edit',
            'admin.hotelroom.delete',
            'admin.hotelroom.bulk-delete',
        ]);
