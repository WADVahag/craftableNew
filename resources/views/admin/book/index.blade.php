                            ...
                            <form @submit.prevent="">
                                ...
                                <div class="row" v-if="showWritersFilter">
                                    ...
                                    <div class="col col-lg-12 col-xl-12 form-group">
                                        <multiselect v-model="writersMultiselect"
                                             :options="{{ $writers->map(function($writer) { return ['key' => $writer->id, 'label' =>  $writer->title]; })->toJson() }}"
                                             label="label"
                                             track-by="key"
                                             placeholder="{{ __('Type to search a writer/s') }}"
                                             :limit="2"
                                             :multiple="true">
                                        </multiselect>
                                    </div>
                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'name'">{{ trans('admin.book.columns.name') }}</th>
                                        <th is='sortable' :column="'description'">{{ trans('admin.book.columns.description') }}</th>
                                        <th is='sortable' :column="'writer_id'">{{ trans('admin.book.columns.writer_id') }}</th>
                                ...
                                <tbody>
                                    ...
                                    <td>@{{ item.id }}</td>
                                        ...
                                        {{-- <td> 
                                            <user-detail-tooltip :user="item.writer.name" v-if="item.writer.name">
                                            </user-detail-tooltip>
